...
class HRect implements Parcelable {
    ...
    public void readFromParcel(final Parcel in) {
            min = in.readParcelable(HPoint.class.getClassLoader());
            max = in.readParcelable(HPoint.class.getClassLoader());
    }
    
    public static final Parcelable.Creator CREATOR =
        new Parcelable.Creator() {
            public HRect createFromParcel(final Parcel in) {
                return new HRect(in);
            }

                        @Override
                        public HRect[] newArray(final int size) {
                                return new HRect[size];
                        }
        };
}
